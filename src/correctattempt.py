...
R1, R2, P1, P2, Q, roi1, roi2 = cv2.stereoRectify(matrix1, distCoeffs, matrix2, distCoeffs,  img1.shape, R3, tvec3/100)

print(roi1)
print(roi2)

mapL1, mapL2 = cv2.initUndistortRectifyMap(matrix1, distCoeffs, R1, P1, img1.shape, cv2.CV_32FC1)
